  ...
  return (
    <HeaderBar>
      <MainHeader>
        ...
        <CenterSize>
          <CenterMenu>
            <button style={{ paddingLeft: "1rem" }}>어디든지</button>
            <Boundary />
              ...
              <SearchIconContainer>
                <svg
                  ...
                  style={{
                    ...
                    width: "12px",
                    stroke: "currentColor",
                    strokeWidth: "5.333333333333333px",
                    overflow: "visible",
                  }}
                  aria-hidden="true"
                  role="presentation"
        ...
        <LastElement>
          <RightMenu>
            <LinkAndLanguage>
              <StartHostButton to="/">
                <Hovering>당신의 공간을 에어비앤비 하세요.</Hovering>
              </StartHostButton>
              <LanguageButton>
                <svg
                  viewBox="0 0 16 16"
...
const LinkAndLanguage = styled.div`
  position: relative;
  display: flex;
  justify-content: flex-end;
  align-items: center;
...
const StartHostButton = styled(Link)`
  font-size: 0.9rem;
  position: relative;
  z-index: 1;
  cursor: pointer;
