...
const CategoryBar = () => {
  ...
  return (
    <CategoryContainer>
      <LeftArrowButtonContainer style={{ zIndex: "5" }}>
        <svg
          viewBox="0 0 32 32"
...
const LeftArrowButtonContainer = styled.div`
  position: absolute;
  display: flex;
...
const RightArrowButtonContainer = styled.div`
  display: flex;
  justify-content: center;
  align-items: center;
...
const CategoryGridLayout = styled.div`
  display: grid;
...
const CatergorySlideContainer = styled.div``;
