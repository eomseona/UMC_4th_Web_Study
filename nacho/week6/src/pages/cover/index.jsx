    ...
    <>
      <html>
        <head>
          ...
          <link
            rel="stylesheet"
            href="https://use.fontawesome.com/releases/v.5.8.2/css/all.css"
        ...
        <body id="cover">
          <header className="showcase">
            <div className="showcase-top">
              ...
              <a href="/nacho/week4/src/App.jsx" className="btn btn-rounded">
                Sign In
              </a>
            </div>
            <div className="showcase-content">
              ...
              <a href="/nacho/week4/src/App.jsx" className="btn btn-x1">
            ...
            <div className="container">
              ...
              <div id="tab-3-content" className="tab-content-item">
                  <div className="text-center">
                      <p className="text-lg">Choose one plane and watch everything on Netflix</p>
